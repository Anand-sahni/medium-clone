    ...
    <div className="mx-auto max-w-7xl">
      ...
      <div className='flex items-center justify-between py-10 bg-yellow-400 border-black border-y lg:py-0'>
        <div className='px-10 space-y-5'>
          ...
          <h2>It's easy and free to post your thinking on any topic and connect with millions of reaaders.</h2>
        </div>
        <img className='hidden h-32 md:inline-flex lg:h-full' src="https://accountabilitylab.org/wp-content/uploads/2020/03/Medium-logo.png" alt="" />
      </div>
