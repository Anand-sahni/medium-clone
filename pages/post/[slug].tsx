        ...
        <main>
            ...
            {submitted ? (
                ...
                <label className='block mb-5'>
                    ...
                    <input {...register("name", { required: true })} type="text" className='block w-full px-3 py-2 mt-1 border rounded shadow outline-none form-input ring-yellow-500 focus:ring' placeholder='Anand sahni' />
                </label>
                <label className='block mb-5'>
                    <span className='text-gray-700'>Email</span>
                    <input {...register("email", { required: true })} type="email" className='block w-full px-3 py-2 mt-1 border rounded shadow outline-none form-input ring-yellow-500 focus:ring' placeholder='anandsahni@gmail.com' />
                </label>
                <label className='block mb-5'>
                    <span className='text-gray-700'>Comment</span>
                    <textarea {...register("comment", { required: true })}  className='block w-full px-3 py-2 mt-1 border rounded shadow outline-none form-textarea ring-yellow-500 focus:ring' rows={8} placeholder='Wow! This was really a masterpiece' />
                </label>
                ...
                <input type="submit" className='px-4 py-2 font-bold text-white bg-yellow-500 shadow cursor-pointer hover:bg-yellow-400 focus:shadow-outline focus:outline-none' />
                </form>
            )}


            <div className='flex flex-col max-w-2xl p-10 mx-auto my-10 shadow-yellow-500'>
